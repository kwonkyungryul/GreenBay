    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
	        ...
	        <form id="login" method="post" action="/users/loginCheck">
	            ...
	            <input type="text" id="user_ID" class="fadeIn second noto" name="user_ID" placeholder="IDENTIFICATION">
	        ...
	        <form id="register" method="post" action="/users/register">
            	...
            	<input type="text" name="user_ID" id="user_ID" class="u_ID fadeIn second noto lalign" placeholder="IDENTIFICATION" />
