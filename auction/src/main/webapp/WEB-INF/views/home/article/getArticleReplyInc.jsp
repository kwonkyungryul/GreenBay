...
<body>
    <div id="container">
        <div id="article_top" class="margin_b20">
            <span class="float_l noto font_18 bold">게시물 답글 달기 페이지 입니다.</span>
		...
		<form method="post" action="/article/setArticleReply" enctype="multipart/form-data">
			...
			<input type="hidden" name="aseq" value="${avo.aseq}" />
			<table>
				<tr><td class="tbl_line" colspan="2"></td></tr>
				<tr class="h_50">
					<td class="w_15p align clr_w bold" style="background-color: #114da5;">게시물 제목</td>
					<td class="w_85p p_lr_5"><input type="text" class="input_full p_lr_10 font_14" name="subject" id="subject" value="[답글] ${avo.subject}" autofocus></td>
				</tr>
				<tr><td class="tbl_line" colspan="2"></td></tr>
				<tr class="h_50">
			...
			<div class="btn_grp margin_t10 margin_b20">
				...
				<span class="float_r">
				<span class="float_l">
					<button type="submit" id="reg_btn" class="btn_80 bo_blue">답글 달기</button>
